...
- **Department of Biostatistics, Columbia University**\hfill New York\newline
  ...
  * Design and code weighted multivariate random forest algorithm independently to predict medication adherence in a interval for an incomplete and class imbalance longitudinal data;
