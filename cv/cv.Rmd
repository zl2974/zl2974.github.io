...
\hfill New York\newline
  ...
  * Improving above-mentioned methods with alternative manifold learning for new data representation, smoothing learned similarity matrix, multi-view fusion or consensus regulation on clustering result
...
- **Department of Biostatistics, Columbia University**\hfill New York\newline
  ...
  * Design simulation study to test algorithm performance
  * Manuscript writing
